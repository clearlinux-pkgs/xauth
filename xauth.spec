...
Version  : 1.1.1
Release  : 22
URL      : https://www.x.org/releases/individual/app/xauth-1.1.1.tar.gz
Source0  : https://www.x.org/releases/individual/app/xauth-1.1.1.tar.gz
Source1  : https://www.x.org/releases/individual/app/xauth-1.1.1.tar.gz.sig
...
%prep
%setup -q -n xauth-1.1.1
cd %{_builddir}/xauth-1.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638529279
...
cp %{_builddir}/xauth-1.1.1/COPYING %{buildroot}/usr/share/package-licenses/xauth/86486fb1779766ab7d69e7240a7bf54ebb86c1ba
%make_install
