...
Version  : 1.1.3
Release  : 24
URL      : https://www.x.org/releases/individual/app/xauth-1.1.3.tar.gz
Source0  : https://www.x.org/releases/individual/app/xauth-1.1.3.tar.gz
Source1  : https://www.x.org/releases/individual/app/xauth-1.1.3.tar.gz.sig
...
%prep
%setup -q -n xauth-1.1.3
cd %{_builddir}/xauth-1.1.3
pushd ..
cp -a xauth-1.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709509396
